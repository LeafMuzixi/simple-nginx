...
dependencies {
    ...
    implementation("org.apache.logging.log4j:log4j-api:${Version.log4j}")
    implementation("org.apache.logging.log4j:log4j-core:${Version.log4j}")
    implementation("org.apache.logging.log4j:log4j-slf4j-impl:${Version.log4j}")
